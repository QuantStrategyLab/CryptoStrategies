...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert (
        ...
        "          ref: 1a6ed98eea5d69ebe6d09ec1cb1e6ec10c4faeed\n"
        "          path: external/QuantPlatformKit"
    ) in workflow
    assert "quant_platform_kit_ref: 1a6ed98eea5d69ebe6d09ec1cb1e6ec10c4faeed" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@1a6ed98eea5d69ebe6d09ec1cb1e6ec10c4faeed" in workflow

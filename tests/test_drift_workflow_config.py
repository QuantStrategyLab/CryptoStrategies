...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 08eed913248953986224e09ea3a8dd9f5ebedc4e" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@08eed913248953986224e09ea3a8dd9f5ebedc4e" in workflow

...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 6677558bbae190c1bb0e287d401d95b731bba5c3" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@6677558bbae190c1bb0e287d401d95b731bba5c3" in workflow

...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: d420441d0e96a020e333ec678ee88f5d964bbb43" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@d420441d0e96a020e333ec678ee88f5d964bbb43" in workflow

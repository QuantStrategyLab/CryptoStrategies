...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 1951dada893f1f05c897e6438b6c687d30b4e810" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@1951dada893f1f05c897e6438b6c687d30b4e810" in workflow

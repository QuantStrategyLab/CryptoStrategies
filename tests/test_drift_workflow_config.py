...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: acc33dd92b979a58a3f40da0fb7b136de8d34785" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@acc33dd92b979a58a3f40da0fb7b136de8d34785" in workflow

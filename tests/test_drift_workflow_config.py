...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 7f140f07ac89f0b4b88347a903906825dde11c39" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@7f140f07ac89f0b4b88347a903906825dde11c39" in workflow

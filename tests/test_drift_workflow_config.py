...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: ff70b162ac8e50e1ece617e570dab76b6740d41e" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@ff70b162ac8e50e1ece617e570dab76b6740d41e" in workflow

...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: cc8891a66cf58d9d339f5d257b412f3f7608a149" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@cc8891a66cf58d9d339f5d257b412f3f7608a149" in workflow

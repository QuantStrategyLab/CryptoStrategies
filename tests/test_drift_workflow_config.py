...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 66cbce0d89d15e4c372b690363c24ea350cc9314" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@66cbce0d89d15e4c372b690363c24ea350cc9314" in workflow

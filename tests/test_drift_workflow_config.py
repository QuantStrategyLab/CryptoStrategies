...
def test_drift_workflow_wires_real_pipeline_inputs_and_preflight_bundle() -> None:
    ...
    assert "ref: 5f1c5497f9e2bbd9bcbef5e5053fab49e6ad45ee" in workflow
    ...
    assert "uses: QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@5f1c5497f9e2bbd9bcbef5e5053fab49e6ad45ee" in workflow
